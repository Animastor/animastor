...
```
Book World
├── Characters   — Берлиоз, Воланд, ...
├── Locations    — Патриаршие пруды, квартира, ...
├── Voices       — Narrator, Берлиоз, ...
├── Visual Style
├── Historical / cultural context
└── User overrides
```

World бывает двух видов:

- **Готовый мир** — известное литературное произведение с уже подготовленными персонажами, локациями и голосовыми концепциями.
- **Пользовательский мир** — человек сам задаёт видение:

> «Я хочу представить Берлиоза вот таким».

И это становится его версией мира.
...
| 3. Книжный мир | Персонажи, локации, голоса, пользовательские паспорта, готовые миры | 2–4 недели |
