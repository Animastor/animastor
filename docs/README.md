...
| [`EDITOR_ENTITY_CRUD.md`](05-frontend/EDITOR_ENTITY_CRUD.md) | **НОВЫЙ.** Editor: ручное Add/Delete персонажей/локаций/голосов (единый паттерн, web + Android, переиспользуем для Unit/Scene) |
