...
порядка/гонки. Рекомендация: gen/token-гвард или снятие предыдущего.
...
- **R2:** накопившиеся `loadedmetadata`-листенеры (см. P1-2) — устаревший seek-таргет
  применяется к новой сцене; самокорректируется порядком вызова.
