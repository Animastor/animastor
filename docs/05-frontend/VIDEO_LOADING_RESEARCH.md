...
файлы готовы к прогрессивной доставке. Базовый размер контента (~43 МБ видео на
просмотренную сцену) не меняется — он неизбежен, пока видео реально играет.
Осталось (варианты B/C): перевести клиенты со скачивания целиком на стриминг по
прямому URL с Range — тогда первый кадр будет появляться через ~1 с, а не после
полной выкачки.
