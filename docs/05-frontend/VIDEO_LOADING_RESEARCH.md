...
файлы готовы к прогрессивной доставке; web-плеер стримит видео (первый кадр за
~1 с вместо полной выкачки). Осталось (вариант C): Android — перевод с
«скачать целиком → локальный файл» на стриминг (MediaPlayer.setDataSource(url)
или ExoPlayer/Media3).
