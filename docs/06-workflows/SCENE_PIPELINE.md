...
|-----------|----------|-------|
| `MAX_SCENES_PER_CHUNK` | 2 | Сколько сцен обрабатывать за раз |
| `CHARS_PER_SCENE` | 2700 | ~400 слов, ~2 минуты звучания |
| `MAX_WINDOW_CHARS` | 5500 | Размер окна текста для AI |
| `--` | нет лимита | AI создаёт сколько нужно сцен |
