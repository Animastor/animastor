...
|---|---|---|---|
| S1.1 Удалить fairness-engine | ✅ завершён | `45b2485` | −618 строк |
| S1.2 Сократить failure-taxonomy + удалить retry-manager | ✅ завершён | `d4444cb` | −736 строк |
...
> retry-budget-manager. Уточнения относительно аудита: C4/C5 в reconcilePhase оказались
> живыми (deps реально прокинуты из `backend.cjs`); из S1.4 удалена только Phase C3.
