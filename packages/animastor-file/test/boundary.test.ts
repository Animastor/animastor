// Package boundary tests — verify that @animastor/web-file never imports
...
// Forbidden imports — these must NEVER appear inside @animastor/web-file
...
describe('@animastor/web-file package boundary', () => {
