// Package boundary tests — verify that @animastor/file never imports
...
// Forbidden imports — these must NEVER appear inside @animastor/file
...
describe('@animastor/file package boundary', () => {
