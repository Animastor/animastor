// ======================================================
// Book Structure Detector — DETERMINISTIC HALF (v2)
// ======================================================
// Physical home (C19 physical extraction,
// docs/architecture/structure-analyzer-extraction-c19.md):
//   This file is the HOST-SIDE PARSER ADAPTER implementation — the
//   deterministic candidate scan + deterministic chapter map that the
//   composition root injects into @animastor/parser via
//   setStructureDetector() (backend.cjs). It is Parser-side deterministic
//   functionality, NOT part of the AI Structure Analyzer
//   (./structure-analyzer/).
//
...
module.exports = {
    ...
    // legacy AI structure.chapters projection (C13/C17 surface)
    mapToStructureChapters,
    // shared heuristics consumed by both the deterministic map and the AI
    // Structure Analyzer (hallucination guards) — part of the frozen
    // StructureDetectorPort surface (C17 §8 / C19)
    isAuthorSurnameACharacter,
    looksLikeAuthorName,
    // canonical structural segment-type labels (keyword group → segment type);
    // also the C13 contract vocabulary
    TYPE_LABELS,
