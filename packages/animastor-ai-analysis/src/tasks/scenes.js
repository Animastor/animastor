...
// shared PURE sanitizeEnvironment predicate from @animastor/vbook-runtime
// (same sharing pattern as the Book Writer write barrier; C21 §3: pure
// utils may be consumed, host infrastructure may not).
