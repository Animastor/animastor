// ======================================================
// Runtime Result Contract — Phase 5 seam (contract module)
// ======================================================
// Moved verbatim from backend/src/contracts/runtime-result.js at the §32.30
// physical extraction of the orchestration contour (backend keeps a
// re-export facade for its existing import paths — this package module is
// the CANONICAL implementation now).
//
// Stable shape of a runtime job/dispatch execution result, exchanged
// between runtime (producer, @animastor/orchestration) and orchestration
// (consumer, @animastor/orchestration) — and through the injected seam at
// the host composition root.
//
// Layer position: this module requires NOTHING relative — it is a leaf, so
// it can never participate in (or create) an import cycle (Phase 5 T8).
