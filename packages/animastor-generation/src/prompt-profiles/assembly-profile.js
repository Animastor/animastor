// ======================================================
// Assembly Profile Resolver — S-4 relocation
// ======================================================
// Moved from image/assembly-profile.js (S-4): the shared prompt-assembly
// profile resolver belongs to Generation Core, not to the image media
// module. All three media types (image, video, audio) resolve their
// prompt-assembly profiles through this module.
//
