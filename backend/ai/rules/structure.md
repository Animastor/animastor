...
## What to identify
1. author — Full name of the author (in %LANGUAGE%). If no clear author found, set null.
2. title — Full title of the work (in %LANGUAGE%). If no clear title found, set null.
...
7. parts — Array of structural parts (sections). Each has:
   - name: the part header text in %LANGUAGE% (e.g., "ЧАСТЬ ПЕРВАЯ")
