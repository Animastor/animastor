...
// requires of the book domain (which is what most backend tests do)
...
//
// This file is the shim layer for the @animastor/vbook-runtime
// preparation phase (no physical move yet):
...
const { setStructureDetector } = require('../src/book/lazy-book/parser');
