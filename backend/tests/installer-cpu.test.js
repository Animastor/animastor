...
collectAsync('11. engine: managed CPU install → CPU torch index, --cpu flag, ownership recorded', async () => {
    ...
    const { io, calls, fs } = createMockIo({
        ...
        files: {
            ...
            '/tmp/repo/packages/animastor-worker/worker/package.json': '{}',
...
function createRealManifestEngineIo(overrides = {}) {
    ...
    const base = {
        ...
        files: {
            '/tmp/repo/packages/animastor-worker/worker/worker.cjs': '// worker v2.0.0',
            '/tmp/repo/packages/animastor-worker/worker/worker-env.cjs': '// env',
            '/tmp/repo/packages/animastor-worker/worker/worker-cleanup.cjs': '// cleanup',
            '/tmp/repo/packages/animastor-worker/worker/worker-cleanup-journal.cjs': '// journal',
            '/tmp/repo/packages/animastor-worker/worker/job-protocol-v2.cjs': '// generated job protocol v2',
            '/tmp/repo/packages/animastor-worker/worker/package.json': '{"name":"animastor-worker"}',
            '/tmp/repo/packages/animastor-worker/worker/package-lock.json': '{}',
