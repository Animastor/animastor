...
//  The only import is the wire type ProgressEvent from api/models —
//  when the package is cut physically, this file (plus the type)
//  moves as-is (precedent: web-player models.ts vendoring).
//
