...
const dict = {
  ru: {
    ...
    worker_setup_step_1: 'Скопируйте credential.',
    worker_setup_step_2: 'Настройте воркер: задайте HUB_URL, ANIMASTOR_WORKER_TOKEN, WORKER_TYPE, WORKER_ID.',
    worker_setup_step_3: 'Запустите воркер.',
    worker_setup_step_4: 'Вернитесь сюда и проверьте статус — Online.',
    worker_setup_hint: 'Используйте те же имена env-переменных, что ожидает worker.cjs. Не меняйте credential в URL — передавайте его только как ANIMASTOR_WORKER_TOKEN.',
  ...
  en: {
    ...
    worker_setup_step_1: 'Copy the credential.',
    worker_setup_step_2: 'Configure the worker: set HUB_URL, ANIMASTOR_WORKER_TOKEN, WORKER_TYPE, WORKER_ID.',
    worker_setup_step_3: 'Start the worker.',
    worker_setup_step_4: 'Return here and check the status — Online.',
