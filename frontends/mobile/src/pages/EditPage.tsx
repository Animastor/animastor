...
//    (GET /preview/...?build_id=), aspect-ratio card heights, and the
//    "Не сгенерировано" overlay when the preview is missing.
...
// ── Carousel card — preview image + aspect-ratio height + missing overlay ──
