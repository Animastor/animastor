...
// Library — 1:1 with LibraryFragment (WebView → iframe to animastor.in,
// the project's own help/release-notes site, see R13 in 06-RISKS).
const LIBRARY_URL = 'https://animastor.in';
